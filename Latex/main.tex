...
\section{Using the Normalized Laplacian Matrix}
\input{tasks/opt_task4.tex}
\section{Testing the algorithm on other datasets}
\input{tasks/opt_task1.tex}
\section{Implementing a method for the eigenvectors and eigenvalues computation}
\input{tasks/opt_task2.tex}
\section{Testing the Inverse Power Method with Deflation}
\input{tasks/opt_task3.tex}
